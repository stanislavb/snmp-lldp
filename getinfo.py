...
if __name__ == "__main__":
	...
	parser.add_argument("-o", "--oidfile", default=defaultOidfile, help="JSON file containing SNMP OIDs (default: %s)" % defaultOidfile)
	parser.add_argument("-w", "--workers", default=defaultWorkers, help="Number of threads to spawn (default: %s)" % defaultWorkers)
